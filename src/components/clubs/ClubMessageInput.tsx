...
interface ClubMessageInputProps {
  onSend: (message: string, mediaType?: string, mediaUrl?: string) => void;
  disabled?: boolean;
  loading?: boolean;
}

export default function ClubMessageInput({ onSend, disabled, loading }: ClubMessageInputProps) {
  const { user } = useAuth();
    ...
    <div className="bg-[#FFFFFF] border-t border-[#FACC15]/30">
      ...
      <form onSubmit={handleSend} className="flex items-center gap-2 p-3">
        ...
        <input
          ...
          placeholder={isRecording ? "Recording voice message..." : "Type a message to the club... ✨"}
          value={value}
