      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="font-bold text-xl">CampusLink</Link>
            <p className="mt-2 text-sm text-gray-600">
              Connecting international and local students across Japanese universities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/feed" className="text-gray-600 hover:text-primary">Discover</Link></li>
              <li><Link to="/matches" className="text-gray-600 hover:text-primary">Matches</Link></li>
              <li><Link to="/chat" className="text-gray-600 hover:text-primary">Messages</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/profile" className="text-gray-600 hover:text-primary">Settings</Link></li>
            </ul>
          </div>
