...
export type Database = {
  public: {
        ...
        Relationships: [
          {
            ...
            columns: ["badge_id"]
            isOneToOne: false
            referencedRelation: "referral_badges"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      ...
      find_nearby_meetups: {
        Args: { user_lat: number; user_lng: number; max_distance: number }
        Returns: {
          id: string
          title: string
          description: string
      ...
      get_accepted_matches: {
        ...
        Returns: {
          ...
          other_user_student_type: string
          other_user_interests: string[]
          other_user_languages: string[]
          other_user_nationality: string
          match_score: number
        }[]
      }
      get_club_meetup_attendance: {
        Args: { club_uuid: string; days: number }
        Returns: Json[]
      }
      get_club_member_growth: {
        Args: { club_uuid: string; days: number }
        Returns: Json[]
      }
      get_club_message_activity: {
        Args: { club_uuid: string; days: number }
        Returns: Json[]
      }
      get_club_rsvp_distribution: {
      ...
      get_referral_leaderboard: {
        Args: { limit_count?: number; include_campus?: boolean }
        Returns: Json[]
      }
      get_referral_stats: {
        Args: { user_id: string }
      ...
      get_user_referral_rank: {
        Args: { user_id: string; include_campus?: boolean }
        Returns: Json
      }
      gettransactionid: {
        Args: Record<PropertyKey, never>
      ...
      update_club_logo: {
        Args: { club_id: string; logo: string }
        Returns: undefined
      }
      update_user_match_preferences: {
        Args: {
